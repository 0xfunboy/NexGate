...
The existing MIT declaration in [package.json](package.json) is retained for material distributed under that grant. The non-commercial document does not revoke that permission or turn the existing package into exclusively non-commercial software.
